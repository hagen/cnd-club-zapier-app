 ...
 */
function listCancelledBookings(z, bundle) {
  ...
  const requestOptions = {
    url: 'https://3zdecsf5dc.execute-api.ap-southeast-2.amazonaws.com/prod/cancelled',
    params: params
  };
